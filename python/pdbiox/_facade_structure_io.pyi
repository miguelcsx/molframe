...
def read_mmtf(data: bytes, options: ReadOptions | None = None) -> ReadReport: ...
def read_pdb(data: bytes | str, options: ReadOptions | None = None) -> ReadReport: ...
def read_pdbqt(data: bytes, options: ReadOptions | None = None) -> ReadReport: ...
def read_pqr(data: bytes, options: ReadOptions | None = None) -> ReadReport: ...
...
def read_policy_overrides(path: str | PathLike[str]) -> PolicyOverrides: ...
