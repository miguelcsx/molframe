...
def crystal_neighbors(structure: object, symmetry: SymmetrySet, model: int = 0, cutoff: float = 5.0, *, limit: int | None = None, backend: object = ...) -> list[CrystalNeighbor]: ...
def crystal_neighbors_with_backend(structure: object, symmetry: SymmetrySet, model: int = 0, cutoff: float = 5.0, backend: object = ...) -> list[CrystalNeighbor]: ...
def crystal_neighbors_with_limit(structure: object, symmetry: SymmetrySet, model: int = 0, cutoff: float = 5.0, *, limit: int) -> list[CrystalNeighbor]: ...
