...
class Plan:
    ...
    def execute(self, structure: Structure | None = None, *, context: core.ExecutionContext | None = None) -> dict[str, object]: ...
    def execute_report(self, structure: Structure | None = None, *, context: core.ExecutionContext | None = None) -> PlanResult: ...
