...
@final
class MsaOptions:
    def __init__(self, scoring: Scoring, *, refinement_passes: int = 0, memory_limit_bytes: int = 100_000_000) -> None: ...
    @staticmethod
    def progressive(scoring: Scoring) -> MsaOptions: ...
    def with_refinement_passes(self, refinement_passes: int) -> MsaOptions: ...
    def with_memory_limit(self, memory_limit_bytes: int) -> MsaOptions: ...
...
@final
class CeOptions:
    def __init__(self, window_size: int, max_gap: int, max_paths: int, fragment_similarity_threshold: float, path_similarity_threshold: float, significance: CeSignificanceProfile | None, memory_limit_bytes: int = 100_000_000) -> None: ...
    @staticmethod
