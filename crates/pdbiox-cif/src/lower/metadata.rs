...
use pdbiox_core::structure::StructureData;
use pdbiox_core::symbol::SymbolId;
use pdbiox_core::topology::{ChainRecord, ChainTable, EntityKind, EntityTable, PolymerKind};
use std::ops::Range;
...
pub(super) fn refresh(
    ...
    if !options.only_atomic_coords {
        data.entry = pdbiox_core::structure::EntryMetadata::default();
        data.cell = None;
