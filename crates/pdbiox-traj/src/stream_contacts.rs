...
use pdbiox_core::{AtomSelection, ExecutionContext};
use pdbiox_spatial::{PairQuery, PeriodicBox, SpatialSearchOptions, count_pairs_within};
...
pub fn contact_counts_stream<R: TrajectoryReader + ?Sized>(
    ...
    if !cutoff.is_finite() || cutoff < 0.0 {
        return Err(pdbiox_spatial::SpatialError::InvalidCutoff.into());
    }
