...
use molframe_core::diagnostic::{Diagnostic, Strictness};
use molframe_core::index::ModelIndex;
use molframe_core::structure::{Structure, validate};
use molframe_query::{Evaluation, Groups, PhysicalQuery, Query};
...
fn with_frame_cell(
    structure: Structure,
    cell: Option<molframe_core::structure::UnitCell>,
