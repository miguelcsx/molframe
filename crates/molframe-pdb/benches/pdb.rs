//! Benchmarks for `molframe-pdb` hot paths.
//!
...
use molframe_bench::{Sample, input, structure, structure_from_pdb};
use molframe_core::io::ReadOptions;
use molframe_pdb::{PdbOptions, hybrid36, read, write, write_mmtf};
