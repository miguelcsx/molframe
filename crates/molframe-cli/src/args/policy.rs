...
impl From<AssemblyArgument> for molframe::AssemblyChoice {
...
impl From<ModelArgument> for molframe::ModelChoice {
...
impl From<AltlocArgument> for molframe::AltlocPolicy {
...
impl From<NamespaceArgument> for molframe::Namespace {
