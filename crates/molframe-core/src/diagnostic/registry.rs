...
registry! {
    ...
    E1402 = Error 1402, Breaking,
        ...
        "the file uses an encoding this version does not implement; upgrade molframe";
    ...
    E3201 = Error 3201, Invalidating,
        ...
        "reinstall molframe from a verified distribution";
    ...
    E9001 = Error 9001, Breaking,
        ...
        "report this as a molframe bug with the input that produced it; no input should be able to cause this";
