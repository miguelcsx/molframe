...
use molframe_cif::{Category, DataBlock, Document};
use molframe_core::{Code, Diagnostic, ModelIndex, Structure};
...
pub const SYMMETRY_EXTENSION: &str = "molframe.xtal.symmetry.v1";
