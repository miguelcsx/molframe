...
#[derive(Clone, Debug)]
pub(crate) struct PyBondChunkProvider(pdbiox::BondChunkProvider);
...
impl PyBondChunkProvider {
    ...
    fn with_rows_per_chunk(
        ...
        pdbiox::BondChunkProvider::with_rows_per_chunk(
            dataset.0,
            first_chunk.0,
            atom_dataset.0,
            atom_logical_start.0,
...
#[derive(Clone, Debug)]
pub(crate) struct PyStructureChunkProvider(pdbiox::StructureChunkProvider);
...
impl PyStructureChunkProvider {
    ...
    fn new(
        ...
        pdbiox::StructureChunkProvider::new(dataset.0, first_chunk.0, structure.structure().clone())
            .map(Self)
            .map_err(value_error)
    }
...
#[derive(Clone, Debug)]
pub(crate) struct PyPropertyChunkProvider(pdbiox::PropertyChunkProvider);
...
impl PyPropertyChunkProvider {
    ...
    fn plddt(
        ...
        pdbiox::PropertyChunkProvider::plddt(
            dataset.0,
            first_chunk.0,
            structure.structure().clone(),
        )
    ...
    fn new(
        ...
        pdbiox::PropertyChunkProvider::new(
            dataset.0,
            first_chunk.0,
            structure.structure().clone(),
            name,
...
#[derive(Clone, Debug)]
pub(crate) struct PyFrameChunkProvider(pdbiox::FrameChunkProvider);
