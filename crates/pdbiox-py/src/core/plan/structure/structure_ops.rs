...
macro_rules! policy_operation {
    ($name:ident, $python:literal, $tag:literal, $variant:ident) => {
        ...
        pub(crate) struct $name {
            pub(crate) request: pdbiox::StructureRequest,
        }
        ...
        impl $name {
            ...
            fn new(policy: Option<PyAnalysisPolicy>) -> Self {
                Self {
                    request: pdbiox::StructureRequest::$variant {
...
impl PyResidueContacts {
    ...
    fn new(
        ...
        Self {
            request: pdbiox::StructureRequest::ContactMap {
                cutoff,
                minimum_separation,
...
impl PyChainInterfaceAnalysis {
    ...
    fn new(
        ...
        Self {
            request: pdbiox::StructureRequest::ChainInterface {
...
impl PyAssignSecondaryStructure {
    ...
    fn new(options: PyDsspOptions, policy: Option<PyAnalysisPolicy>) -> Self {
        Self {
            request: pdbiox::StructureRequest::SecondaryStructure {
...
impl PyHalfSphereExposureAnalysis {
    ...
    fn new(
        ...
        Self {
            request: pdbiox::StructureRequest::HalfSphereExposure {
                radius,
                backend: match backend {
                    Some(backend) => backend,
                    None => PySpatialBackend::Auto,
...
impl PyGnm {
    ...
    fn new(
        ...
        Self {
            request: pdbiox::StructureRequest::GaussianNetworkModel {
