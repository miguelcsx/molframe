...
impl PyBasePairs {
    ...
    fn new(
        ...
        Ok(Self {
            request: pdbiox::StructureRequest::BasePairs {
                provider,
...
fn component_provider(
    py: Python<'_>,
    dictionary: &Py<PyAny>,
) -> PyResult<Arc<dyn pdbiox::ComponentProvider>> {
...
impl PyHydrogenBonds {
    ...
    fn new(
        ...
        Self {
            request: pdbiox::StructureRequest::HydrogenBonds {
...
impl PySaltBridges {
    ...
    fn new(
        ...
        Self {
            request: pdbiox::StructureRequest::SaltBridges {
                maximum_distance,
                backend: match backend {
                    Some(backend) => backend,
                    None => PySpatialBackend::Auto,
