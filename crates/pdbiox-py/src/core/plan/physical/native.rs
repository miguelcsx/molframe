...
) -> PyResult<pdbiox::PhysicalRequest> {
    Ok(match operation {
        PyPhysicalOperation::RadialDistribution {
            ...
            periodic,
            policy,
        } => pdbiox::PhysicalRequest::RadialDistribution {
            left: left.clone(),
            right: right.clone(),
            options: *options,
            periodic: *periodic,
        ...
        PyPhysicalOperation::CoordinationNumbers {
            ...
            periodic,
            policy,
        } => pdbiox::PhysicalRequest::CoordinationNumbers {
            left: left.clone(),
            right: right.clone(),
        ...
        PyPhysicalOperation::Leaflets {
            ...
            periodic,
            policy,
        } => pdbiox::PhysicalRequest::Leaflets {
            sites: sites.clone(),
            options: *options,
            periodic: *periodic,
            policy: policy.clone(),
        ...
        PyPhysicalOperation::LinearDensity {
            ...
            options,
            policy,
        } => pdbiox::PhysicalRequest::LinearDensity {
        ...
        PyPhysicalOperation::DensityMap {
            ...
            spec,
            policy,
        } => pdbiox::PhysicalRequest::DensityMap {
            weights: retain_scalar(py, weights, scalar_arrays, scalar_slots)?,
            spec: *spec,
            policy: policy.clone(),
        },
        PyPhysicalOperation::PoreProfile {
            ...
            options,
            policy,
        } => pdbiox::PhysicalRequest::PoreProfile {
        ...
        PyPhysicalOperation::SurfaceContacts {
            ...
            backend,
            policy,
        } => pdbiox::PhysicalRequest::SurfaceContacts {
            radii: retain_float(py, radii, float_arrays, float_slots)?,
            tolerance: *tolerance,
            probe: *probe,
            density: *density,
