...
pub(crate) struct PyMemoryBudget(pdbiox::core::MemoryBudget);

#[pymethods]
impl PyMemoryBudget {
    #[new]
    #[pyo3(signature = (bytes=pdbiox::core::execution::DEFAULT_MEMORY_BUDGET_BYTES))]
    fn new(bytes: usize) -> PyResult<Self> {
        pdbiox::core::MemoryBudget::new(bytes)
            .map(Self)
            .map_err(value_error)
    }
...
pub(crate) struct PyCancellationToken(pdbiox::core::CancellationToken);
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyScratchPolicy(pdbiox::core::ScratchPolicy);
...
impl PyScratchPolicy {
    ...
    fn new(max_bytes: usize) -> Self {
        Self(pdbiox::core::ScratchPolicy::new(max_bytes))
    }
...
#[derive(Clone, Debug, Default)]
pub(crate) struct PyTempStoragePolicy(pdbiox::core::TempStoragePolicy);
...
impl PyTempStoragePolicy {
    ...
    fn directory(root: PathBuf, max_bytes: u64) -> Self {
        Self(pdbiox::core::TempStoragePolicy::directory(root, max_bytes))
    }
...
#[derive(Clone, Debug)]
pub(crate) struct PyExecutionContext(pdbiox::core::ExecutionContext);

impl PyExecutionContext {
    pub(crate) fn native(&self) -> pdbiox::core::ExecutionContext {
        self.0.clone()
    }

    pub(crate) fn from_native(value: pdbiox::core::ExecutionContext) -> Self {
        Self(value)
    }
}

pub(crate) fn default_context() -> pdbiox::core::ExecutionContext {
    pdbiox::core::ExecutionContext::default()
}

#[pyclass(name = "WindowedFile", skip_from_py_object)]
#[derive(Debug)]
pub(crate) struct PyWindowedFile(Mutex<pdbiox::core::WindowedFile>);

#[pymethods]
impl PyWindowedFile {
    #[new]
    fn new(path: PathBuf, max_window_bytes: usize, context: &PyExecutionContext) -> PyResult<Self> {
        pdbiox::core::WindowedFile::open(path, max_window_bytes, &context.0)
...
impl PyExecutionContext {
    ...
    fn new(
        ...
        let mut builder = pdbiox::core::ExecutionContext::builder();
...
#[derive(Debug)]
pub(crate) struct PyMemoryLease(pdbiox::core::MemoryReservation);
...
#[derive(Debug)]
pub(crate) struct PySpillFile(Option<pdbiox::core::SpillFile>);
...
#[derive(Debug)]
pub(crate) struct PySpillArtifact(pdbiox::core::SpillArtifact);
...
pub(crate) struct PySpillReader {
    reader: pdbiox::core::SpillReader,
    buffer: Vec<u8>,
}
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyBatchDemand(pdbiox::core::BatchDemand);

impl PyBatchDemand {
    pub(crate) const fn native(self) -> pdbiox::core::BatchDemand {
        self.0
    }
}
...
impl PyBatchDemand {
    ...
    fn new(max_rows: usize, max_bytes: usize) -> Self {
        Self(pdbiox::core::BatchDemand::new(max_rows, max_bytes))
    }
...
pub(crate) fn register(module: &Bound<'_, PyModule>) -> PyResult<()> {
    module.add(
        ...
        pdbiox::core::execution::DEFAULT_MEMORY_BUDGET_BYTES,
    )?;
