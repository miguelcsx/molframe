...
impl PyMissingResidue {
    pub(crate) fn from_sequence(value: pdbiox::MissingResidue, component: &str) -> Self {
        Self {
...
impl PyPlanarityOptions {
    pub(crate) const fn from_native_parts(value: pdbiox::validate::PlanarityOptions) -> Self {
        Self(value)
    }
}
