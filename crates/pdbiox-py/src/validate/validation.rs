...
impl From<pdbiox::validate::QualityFlag> for PyQualityFlag {
    fn from(value: pdbiox::validate::QualityFlag) -> Self {
        let issue = match value.issue {
            pdbiox::validate::QualityIssue::ZeroOccupancy => PyQualityIssue::ZeroOccupancy,
            pdbiox::validate::QualityIssue::OccupancyOutOfRange => {
                PyQualityIssue::OccupancyOutOfRange
            }
            pdbiox::validate::QualityIssue::NegativeBFactor => PyQualityIssue::NegativeBFactor,
        };
        Self {
            atom: value.atom.get(),
            issue,
...
impl PyRamachandranRecord {
    pub(super) fn rust_record(&self) -> pdbiox::validate::RamachandranRecord {
        pdbiox::validate::RamachandranRecord {
            residue: pdbiox::ResidueIndex::new(self.residue),
            phi: self.phi,
            psi: self.psi,
            region: match self.region {
                ...
                PyRamachandranRegion::BetaSheet => pdbiox::validate::RamachandranRegion::BetaSheet,
                PyRamachandranRegion::AlphaHelixLeft => {
                    pdbiox::validate::RamachandranRegion::AlphaHelixLeft
                }
                PyRamachandranRegion::Outlier => pdbiox::validate::RamachandranRegion::Outlier,
            },
            reference: pdbiox::validate::ReferenceAssessment {
...
impl From<pdbiox::validate::RamachandranRegion> for PyRamachandranRegion {
    fn from(value: pdbiox::validate::RamachandranRegion) -> Self {
        match value {
            pdbiox::validate::RamachandranRegion::AlphaHelixRight => Self::AlphaHelixRight,
            pdbiox::validate::RamachandranRegion::BetaSheet => Self::BetaSheet,
            pdbiox::validate::RamachandranRegion::AlphaHelixLeft => Self::AlphaHelixLeft,
            pdbiox::validate::RamachandranRegion::Outlier => Self::Outlier,
        }
    }
}

impl From<pdbiox::validate::RamachandranRecord> for PyRamachandranRecord {
    fn from(value: pdbiox::validate::RamachandranRecord) -> Self {
        Self {
...
impl PyStructure {
    ...
    fn ramachandran(
        ...
        let values = py
            .detach(move || {
                let options = pdbiox::validate::RamachandranOptions::new(
                    &references,
                    basins,
                    minimum_probability,
                )
        ...
        Ok(values
            ...
            .map(|value| PyRamachandranRecord {
                ...
                region: match value.region {
                    ...
                    pdbiox::validate::RamachandranRegion::BetaSheet => {
                        PyRamachandranRegion::BetaSheet
                    }
                    pdbiox::validate::RamachandranRegion::AlphaHelixLeft => {
                        PyRamachandranRegion::AlphaHelixLeft
                    }
                    pdbiox::validate::RamachandranRegion::Outlier => PyRamachandranRegion::Outlier,
                },
                reference_id: value.reference.set.into(),
                reference_version: value.reference.version.into(),
                distribution: value.reference.distribution.into(),
