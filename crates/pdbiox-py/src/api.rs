//! Structure-comparison and sequence binding exports.
...
mod mapping;
#[path = "seq/sequence.rs"]
mod sequence;
#[path = "seq/sequence_alphabet.rs"]
mod sequence_alphabet;
#[path = "seq/sequence_dispatch.rs"]
mod sequence_dispatch;
#[path = "seq/sequence_errors.rs"]
mod sequence_errors;
#[path = "seq/sequence_extended.rs"]
mod sequence_extended;
#[path = "seq/sequence_formats.rs"]
mod sequence_formats;
#[path = "seq/sequence_kmer.rs"]
mod sequence_kmer;
...
pub(crate) use sequence_extended::{
    ...
    align_local_matrix, align_semi_global_matrix, blosum62, global_score, kmer_counts, minimizers,
