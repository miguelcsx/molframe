...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyNeighborListOptions(pub(crate) pdbiox::NeighborListOptions);
...
impl PyNeighborListOptions {
    ...
    fn new(skin: f32, cell_grid: Option<PyCellGridOptions>) -> Self {
        let mut inner = pdbiox::NeighborListOptions::with_skin(skin);
    ...
    fn with_skin(skin: f32) -> Self {
        Self(pdbiox::NeighborListOptions::with_skin(skin))
    }
...
impl PyKdPeriodicOptions {
    pub(crate) const fn inner(self) -> pdbiox::KdPeriodicOptions {
...
impl PySpatialSearchOptions {
    pub(crate) const fn from_native(value: pdbiox::SpatialSearchOptions) -> Self {
        Self(value)
    }

    pub(crate) const fn balanced_value() -> Self {
        Self::from_native(pdbiox::SpatialSearchOptions::BALANCED)
    }

    pub(crate) const fn inner(self) -> pdbiox::SpatialSearchOptions {
        self.0
    }
}
...
pub(crate) fn normalize_selection(
    ...
    count: usize,
) -> Result<pdbiox::AtomSelection, String> {
