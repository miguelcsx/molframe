...
pub(crate) struct PyMotifBenchMeasurements(pub(crate) pdbiox::fx::MotifBenchMeasurements);
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyAmeMeasurements(pub(crate) pdbiox::fx::AmeMeasurements);
