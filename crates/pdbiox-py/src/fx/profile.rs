...
impl From<pdbiox::fx::ProfileAtomSet> for PyProfileAtomSet {
    fn from(value: pdbiox::fx::ProfileAtomSet) -> Self {
        match value {
            pdbiox::fx::ProfileAtomSet::FullScaffoldCAlpha => Self::FullScaffoldCAlpha,
            pdbiox::fx::ProfileAtomSet::MotifBackboneWithOxygen => Self::MotifBackboneWithOxygen,
            pdbiox::fx::ProfileAtomSet::CatalyticBackbone => Self::CatalyticBackbone,
            pdbiox::fx::ProfileAtomSet::CatalyticHeavyAtoms => Self::CatalyticHeavyAtoms,
            pdbiox::fx::ProfileAtomSet::LigandAndBackbone => Self::LigandAndBackbone,
            _ => Self::Unknown,
        }
    }
}
...
impl From<pdbiox::fx::ProfileAlignment> for PyProfileAlignment {
    fn from(value: pdbiox::fx::ProfileAlignment) -> Self {
        match value {
            pdbiox::fx::ProfileAlignment::MeasuredAtoms => Self::MeasuredAtoms,
            pdbiox::fx::ProfileAlignment::CatalyticBackbone => Self::CatalyticBackbone,
            pdbiox::fx::ProfileAlignment::PredictionFrame => Self::PredictionFrame,
            _ => Self::Unknown,
        }
    }
}
...
impl From<pdbiox::fx::ProfileMetric> for PyProfileMetric {
    fn from(value: pdbiox::fx::ProfileMetric) -> Self {
        Self {
...
impl From<pdbiox::fx::CandidateAggregation> for PyCandidateAggregation {
    fn from(value: pdbiox::fx::CandidateAggregation) -> Self {
        match value {
            pdbiox::fx::CandidateAggregation::Any => Self::Any,
        }
    }
}
...
#[derive(Clone, Debug)]
pub(crate) struct PyCompatibilityProfile(pub(crate) pdbiox::fx::CompatibilityProfile);
...
#[derive(Clone, Debug)]
pub(crate) struct PyCompatibilityVerdict(pub(crate) pdbiox::fx::CompatibilityVerdict);
