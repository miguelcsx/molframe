...
impl From<pdbiox::traj::AmberSection> for PyAmberSection {
    fn from(value: pdbiox::traj::AmberSection) -> Self {
        Self {
...
impl From<PyAmberSection> for pdbiox::traj::AmberSection {
...
impl From<pdbiox::traj::AmberTopologyAtom> for PyAmberTopologyAtom {
    fn from(value: pdbiox::traj::AmberTopologyAtom) -> Self {
        Self {
...
impl From<PyAmberTopologyAtom> for pdbiox::traj::AmberTopologyAtom {
...
impl From<pdbiox::traj::AmberTopologyResidue> for PyAmberTopologyResidue {
    fn from(value: pdbiox::traj::AmberTopologyResidue) -> Self {
        Self {
            name: value.name.into(),
...
impl From<PyAmberTopologyResidue> for pdbiox::traj::AmberTopologyResidue {
...
macro_rules! topology_tuple {
    ($name:ident, $python_name:literal, $native:ident, $atoms:ty) => {
        ...
        impl From<pdbiox::traj::$native> for $name {
            fn from(value: pdbiox::traj::$native) -> Self {
                Self {
                    atoms: value.atoms,
        ...
        impl From<$name> for pdbiox::traj::$native {
...
impl From<pdbiox::traj::AmberTopologyDihedral> for PyAmberTopologyDihedral {
    fn from(value: pdbiox::traj::AmberTopologyDihedral) -> Self {
        Self {
            atoms: value.atoms,
            parameter: value.parameter,
...
impl From<PyAmberTopologyDihedral> for pdbiox::traj::AmberTopologyDihedral {
...
impl From<pdbiox::traj::AmberTopology> for PyAmberTopology {
    fn from(value: pdbiox::traj::AmberTopology) -> Self {
        Self {
...
impl From<pdbiox::traj::PsfAtom> for PyPsfAtom {
    fn from(value: pdbiox::traj::PsfAtom) -> Self {
        Self {
...
impl From<PyPsfAtom> for pdbiox::traj::PsfAtom {
...
impl From<pdbiox::traj::PsfTopology> for PyPsfTopology {
    fn from(value: pdbiox::traj::PsfTopology) -> Self {
        Self {
...
impl From<PyPsfTopology> for pdbiox::traj::PsfTopology {
