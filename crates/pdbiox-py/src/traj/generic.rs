...
impl From<PyFrame> for pdbiox::traj::Frame {
...
impl From<pdbiox::traj::Frame> for PyFrame {
    fn from(value: pdbiox::traj::Frame) -> Self {
        Self {
            positions: value.positions,
        }
    }
...
impl From<pdbiox::traj::Units> for PyUnits {
    fn from(value: pdbiox::traj::Units) -> Self {
        Self {
            length: value.length,
            time: value.time,
            force: value.force,
...
impl PyMemoryReader {
    ...
    fn units(&self) -> PyUnits {
        pdbiox::traj::Units::CANONICAL.into()
    }
