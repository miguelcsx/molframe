...
impl From<PyNamdEndian> for pdbiox::traj::NamdEndian {
...
impl From<pdbiox::traj::NamdEndian> for PyNamdEndian {
    fn from(value: pdbiox::traj::NamdEndian) -> Self {
        match value {
            pdbiox::traj::NamdEndian::Little => Self::Little,
            pdbiox::traj::NamdEndian::Big => Self::Big,
        }
    }
}
...
impl TryFrom<pdbiox::traj::NamdBinary> for PyNamdBinary {
    type Error = PyErr;

    fn try_from(value: pdbiox::traj::NamdBinary) -> Result<Self, Self::Error> {
        Ok(Self {
