...
impl TryFrom<pdbiox::traj::FrameValue> for PyFrameValue {
    type Error = PyErr;

    fn try_from(value: pdbiox::traj::FrameValue) -> Result<Self, Self::Error> {
        match value {
            pdbiox::traj::FrameValue::Float(value) => Ok(Self::float(value)),
            pdbiox::traj::FrameValue::Integer(value) => Ok(Self::integer(value)),
            pdbiox::traj::FrameValue::Text(value) => Ok(Self::text(value.into())),
            pdbiox::traj::FrameValue::Floats(value) => Ok(Self::floats(value)),
...
impl TryFrom<PyFrameValue> for pdbiox::traj::FrameValue {
    type Error = PyErr;
...
impl TryFrom<PyTimestep> for pdbiox::traj::Timestep {
    type Error = PyErr;
...
impl TryFrom<pdbiox::traj::Timestep> for PyTimestep {
    type Error = PyErr;

    fn try_from(value: pdbiox::traj::Timestep) -> Result<Self, Self::Error> {
