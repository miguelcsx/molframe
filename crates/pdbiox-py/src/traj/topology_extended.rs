...
fn hoomd_interaction<const N: usize>(
    value: pdbiox::traj::HoomdInteraction<N>,
) -> PyHoomdInteraction {
    PyHoomdInteraction {
...
impl From<pdbiox::traj::HoomdConfiguration> for PyHoomdConfiguration {
    fn from(value: pdbiox::traj::HoomdConfiguration) -> Self {
        Self {
            step: value.step,
...
impl TryFrom<pdbiox::traj::LammpsAtomStyle> for PyLammpsAtomStyle {
    type Error = PyErr;

    fn try_from(value: pdbiox::traj::LammpsAtomStyle) -> Result<Self, Self::Error> {
        match value {
            pdbiox::traj::LammpsAtomStyle::Atomic => Ok(Self::Atomic),
            pdbiox::traj::LammpsAtomStyle::Charge => Ok(Self::Charge),
            pdbiox::traj::LammpsAtomStyle::Molecular => Ok(Self::Molecular),
            pdbiox::traj::LammpsAtomStyle::Full => Ok(Self::Full),
...
impl From<pdbiox::traj::LammpsDataAtom> for PyLammpsDataAtom {
    fn from(value: pdbiox::traj::LammpsDataAtom) -> Self {
        Self {
            id: value.id,
...
fn lammps_interaction<const N: usize>(
    value: pdbiox::traj::LammpsInteraction<N>,
) -> PyLammpsInteraction {
    PyLammpsInteraction {
        id: value.id,
...
impl TryFrom<pdbiox::traj::LammpsData> for PyLammpsData {
    type Error = PyErr;

    fn try_from(value: pdbiox::traj::LammpsData) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl From<pdbiox::traj::TprTopology> for PyTprTopology {
    fn from(value: pdbiox::traj::TprTopology) -> Self {
        Self {
            header: PyTprHeader {
