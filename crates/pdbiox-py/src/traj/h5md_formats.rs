...
pub(crate) struct PyH5mdUnitSystem {
    pub(crate) inner: pdbiox::traj::H5mdUnitSystem,
}
...
impl PyH5mdUnitSystem {
    ...
    fn new(
        ...
        let inner = pdbiox::traj::H5mdUnitSystem {
            length_unit,
            length_to_angstrom,
            time_unit,
            time_to_picosecond,
    ...
    fn canonical() -> Self {
        Self {
            inner: pdbiox::traj::H5mdUnitSystem::canonical(),
        }
    }
...
pub(crate) struct PyH5mdOptions {
    pub(crate) inner: pdbiox::traj::H5mdOptions,
}
...
impl PyH5mdOptions {
    ...
    fn new(particle_group: &str, units: Option<PyRef<'_, PyH5mdUnitSystem>>) -> Self {
        let defaults = pdbiox::traj::H5mdOptions::default();
        Self {
            inner: pdbiox::traj::H5mdOptions {
...
impl From<PyH5mdOptions> for pdbiox::traj::H5mdOptions {
...
impl From<pdbiox::traj::H5mdMetadata> for PyH5mdMetadata {
    fn from(value: pdbiox::traj::H5mdMetadata) -> Self {
        Self {
...
impl From<PyH5mdMetadata> for pdbiox::traj::H5mdMetadata {
...
impl TryFrom<pdbiox::traj::H5mdTrajectory> for PyH5mdTrajectory {
    type Error = PyErr;

    fn try_from(value: pdbiox::traj::H5mdTrajectory) -> Result<Self, Self::Error> {
        let frames = value
            .frames
            .into_iter()
