...
pub(crate) struct PyFormatMetadata {
    inner: pdbiox::traj::FormatMetadata,
}
...
impl PyFormatMetadata {
    ...
    fn none() -> Self {
        Self {
            inner: pdbiox::traj::FormatMetadata::None,
        }
    }
    ...
    fn kind(&self) -> &'static str {
        match &self.inner {
            pdbiox::traj::FormatMetadata::None => "none",
            pdbiox::traj::FormatMetadata::Xtc { .. } => "xtc",
            pdbiox::traj::FormatMetadata::Trr { .. } => "trr",
            pdbiox::traj::FormatMetadata::Dcd(_) => "dcd",
            pdbiox::traj::FormatMetadata::AmberNetcdf(_) => "amber_netcdf",
            pdbiox::traj::FormatMetadata::Tng { .. } => "tng",
            pdbiox::traj::FormatMetadata::Gsd(_) => "gsd",
            pdbiox::traj::FormatMetadata::H5md(_) => "h5md",
            pdbiox::traj::FormatMetadata::Trz { .. } => "trz",
            pdbiox::traj::FormatMetadata::Namd(_) => "namd",
            pdbiox::traj::FormatMetadata::AmberRestart { .. } => "amber_restart",
            pdbiox::traj::FormatMetadata::AmberAscii { .. } => "amber_ascii",
            pdbiox::traj::FormatMetadata::Gro(_) => "gro",
            pdbiox::traj::FormatMetadata::Xyz(_) => "xyz",
            pdbiox::traj::FormatMetadata::Aims(_) => "aims",
            pdbiox::traj::FormatMetadata::Txyz(_) => "txyz",
            pdbiox::traj::FormatMetadata::DlPolyConfig(_) => "dlpoly_config",
            pdbiox::traj::FormatMetadata::DlPolyHistory(_) => "dlpoly_history",
            pdbiox::traj::FormatMetadata::CharmmCard(_) => "charmm_card",
            pdbiox::traj::FormatMetadata::Gamess(_) => "gamess",
            pdbiox::traj::FormatMetadata::Gromos11(_) => "gromos11",
            pdbiox::traj::FormatMetadata::Dms(_) => "dms",
            _ => "unknown",
        }
    }
