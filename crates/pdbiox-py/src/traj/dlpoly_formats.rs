...
impl From<PyDlPolyAtom> for pdbiox::traj::DlPolyAtom {
...
impl From<pdbiox::traj::DlPolyAtom> for PyDlPolyAtom {
    fn from(value: pdbiox::traj::DlPolyAtom) -> Self {
        Self {
            name: value.name.into(),
            index: value.index,
            mass: value.mass,
...
impl From<PyDlPolyFrame> for pdbiox::traj::DlPolyFrame {
...
impl From<pdbiox::traj::DlPolyFrame> for PyDlPolyFrame {
    fn from(value: pdbiox::traj::DlPolyFrame) -> Self {
        Self {
            step: value.step,
            time: value.time,
            positions: value.positions,
...
impl From<PyDlPolyConfig> for pdbiox::traj::DlPolyConfig {
...
impl From<pdbiox::traj::DlPolyConfig> for PyDlPolyConfig {
    fn from(value: pdbiox::traj::DlPolyConfig) -> Self {
        Self {
            title: value.title.into(),
            level: value.level,
            boundary: value.boundary,
...
impl From<PyDlPolyHistory> for pdbiox::traj::DlPolyHistory {
...
impl From<pdbiox::traj::DlPolyHistory> for PyDlPolyHistory {
    fn from(value: pdbiox::traj::DlPolyHistory) -> Self {
        Self {
            title: value.title.into(),
            level: value.level,
            boundary: value.boundary,
