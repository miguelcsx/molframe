...
#[derive(Clone, Debug)]
pub(crate) struct PyMol2AtomMetadata(pub(crate) pdbiox::Mol2AtomMetadata);
...
impl PyMol2AtomMetadata {
    ...
    fn new(
        ...
        Ok(Self(pdbiox::Mol2AtomMetadata {
            id,
...
#[derive(Clone, Debug)]
pub(crate) struct PyMol2BondMetadata(pub(crate) pdbiox::Mol2BondMetadata);
...
impl PyMol2BondMetadata {
    ...
    fn new(id: usize, bond_type: String, status_bits: Option<String>) -> PyResult<Self> {
        ...
        Ok(Self(pdbiox::Mol2BondMetadata {
            id,
...
#[derive(Clone, Debug)]
pub(crate) struct PyMol2Section(pub(crate) pdbiox::Mol2Section);
...
#[derive(Clone, Debug)]
pub(crate) struct PyMol2Record(pub(crate) pdbiox::Mol2Record);
