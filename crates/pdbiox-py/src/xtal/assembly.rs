...
#[derive(Clone, Debug)]
pub(crate) struct PyAssemblySet(pub(crate) pdbiox::xtal::AssemblySet);
...
#[derive(Clone, Debug)]
pub(crate) struct PyAssemblyView(pub(crate) pdbiox::xtal::AssemblyView);
...
impl PyStructure {
    fn assembly_set(&self) -> Option<PyAssemblySet> {
        pdbiox::xtal::AssemblyExt::assembly_set(self.structure())
            .cloned()
            .map(PyAssemblySet)
    }
    ...
    fn assembly(&self, id: &str, limit: Option<usize>) -> PyResult<PyAssemblyView> {
        let result = match limit {
            Some(limit) => {
                let assemblies = pdbiox::xtal::AssemblyExt::assembly_set(self.structure())
                    .ok_or_else(|| value_error("structure has no assembly metadata"))?;
                pdbiox::xtal::AssemblyView::with_limit(self.structure(), assemblies, id, limit)
            }
            None => pdbiox::xtal::AssemblyExt::assembly(self.structure(), id),
        };
...
impl From<pdbiox::xtal::ChainInstance> for PyChainInstance {
    fn from(value: pdbiox::xtal::ChainInstance) -> Self {
        Self {
...
impl From<pdbiox::xtal::AtomInstance> for PyAtomInstance {
    fn from(value: pdbiox::xtal::AtomInstance) -> Self {
        Self {
...
impl From<pdbiox::xtal::AssemblyNeighbor> for PyAssemblyNeighbor {
    fn from(value: pdbiox::xtal::AssemblyNeighbor) -> Self {
        Self {
