...
use super::{
    ...
    PyHarmonicSimilarity, PyKMeans, PyKMeansOptions, PyLinkage, PyRemainderPolicy,
};
...
impl PyEnsembleDistanceMatrix {
    pub(super) fn native(&self) -> pdbiox::traj::EnsembleDistanceMatrix {
...
impl PyKMeansOptions {
    pub(super) fn native(&self) -> pdbiox::traj::KMeansOptions<'_> {
