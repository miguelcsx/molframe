...
impl InputBuffer {
    ...
    /// [`pdbiox_mmap::MappedFile::map_file_unchecked`], in the crate that
    /// audits it, written by the caller who is in a position to make the
    /// promise. By the time a [`MappedFile`](pdbiox_mmap::MappedFile) exists
    ...
    #[cfg(feature = "mmap")]
    #[must_use]
    pub fn from_mapped(mapped: pdbiox_mmap::MappedFile) -> Self {
