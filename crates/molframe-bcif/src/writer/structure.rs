...
use molframe_cif::{CanonicalProjection, CifWriteError, CifWriteOptions, canonical_projection};
use molframe_core::diagnostic::{Code, Diagnostic};
use molframe_core::io::DEFAULT_OUTPUT_MEMORY_LIMIT_BYTES;
...
pub fn write_structure_to_with_memory_limit<W: Write>(
    ...
    let file = StreamingFile {
        projection,
        rows,
        encoder: format!("molframe {}", env!("CARGO_PKG_VERSION")),
