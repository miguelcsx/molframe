...
use marker::Value;
use molframe_core::{Diagnostic, ExecutionContext, MemoryReservation, SourceBytes};
use std::ops::Range;
...
fn index_memory(error: impl std::fmt::Display) -> Diagnostic {
    Diagnostic::new(molframe_core::Code::E1902).with_context("reason", error.to_string())
}
