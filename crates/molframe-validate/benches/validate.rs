...
use molframe_geom::EigenOptions;
use molframe_spatial::SpatialBackend;
use molframe_validate::{
...
fn bench_extended_chirality(
    ...
    let provider = match molframe_chem::MemoryProvider::new(
        molframe_core::contract::DictionaryVersion::new("empty"),
        std::iter::empty::<molframe_chem::Component>(),
    ) {
    ...
    group.bench_function("chirality_outliers/medium", |b| {
        b.iter(|| {
            black_box(chirality_outliers(
                ...
                molframe_validate::ChiralityOptions {
