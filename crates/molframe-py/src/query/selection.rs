...
use molframe::query::{LogicalPlan, PhysicalQuery};
use molframe::{AnalysisPolicy, AtomSelection, Groups, Query, QueryStructure};
...
impl From<molframe::Evaluation> for PyEvaluation {
    fn from(value: molframe::Evaluation) -> Self {
        Self {
