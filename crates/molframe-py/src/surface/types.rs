...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyAtomDepthOptions(pub(crate) molframe::surface::AtomDepthOptions);

#[pymethods]
impl PyAtomDepthOptions {
    #[new]
    fn new(cell_size: f64) -> Self {
        Self(molframe::surface::AtomDepthOptions { cell_size })
    }
}
...
pub(crate) struct PySolventExcludedSurface {
    ...
    #[pyo3(get)]
    area: f64,
    pub(crate) native: molframe::surface::SolventExcludedSurface,
}
...
pub(crate) struct PyIndexedSurfaceMesh {
    pub(crate) native: molframe::surface::IndexedSurfaceMesh,
}
...
impl PyIndexedSurfaceMesh {
    ...
    fn new(vertices: PyReadonlyArray2<'_, f32>, faces: Vec<[u32; 3]>) -> PyResult<Self> {
        ...
        Ok(Self {
            native: molframe::surface::IndexedSurfaceMesh::new(
                vertices,
                faces
                    .into_iter()
                    .map(molframe::surface::SurfaceFace)
                    .collect(),
            ),
        })
    }
...
impl From<PyMoleculeRole> for molframe::surface::MoleculeRole {
...
impl From<molframe::surface::SurfacePoint> for PySurfacePoint {
    fn from(value: molframe::surface::SurfacePoint) -> Self {
        Self {
            atom: value.atom,
...
impl From<molframe::surface::ExcludedSurfacePoint> for PyExcludedSurfacePoint {
    fn from(value: molframe::surface::ExcludedSurfacePoint) -> Self {
        Self {
            atom: value.atom,
...
impl From<molframe::surface::AtomContactArea> for PyAtomContactArea {
    fn from(value: molframe::surface::AtomContactArea) -> Self {
        Self {
            first: value.first,
            second: value.second,
            area: value.area,
...
impl From<molframe::surface::BuriedSurface> for PyBuriedSurface {
    fn from(value: molframe::surface::BuriedSurface) -> Self {
        Self {
...
impl From<molframe::surface::Cavity> for PyCavity {
    fn from(value: molframe::surface::Cavity) -> Self {
        Self {
            volume: value.volume,
...
impl From<molframe::surface::SurfaceTriangle> for PySurfaceTriangle {
    fn from(value: molframe::surface::SurfaceTriangle) -> Self {
        Self {
...
impl From<molframe::surface::SolventExcludedSurface> for PySolventExcludedSurface {
    fn from(value: molframe::surface::SolventExcludedSurface) -> Self {
        Self {
...
impl PyIndexedSurfaceMesh {
    pub(crate) fn from_native(native: molframe::surface::IndexedSurfaceMesh) -> Self {
        Self { native }
    }
}

impl From<molframe::surface::MeshReport> for PyMeshReport {
    fn from(value: molframe::surface::MeshReport) -> Self {
        Self {
...
impl From<molframe::surface::SurfaceDistances> for PySurfaceDistances {
    fn from(value: molframe::surface::SurfaceDistances) -> Self {
        Self {
            source: value.source,
...
impl From<molframe::surface::CurvatureQuality> for PyCurvatureQuality {
    fn from(value: molframe::surface::CurvatureQuality) -> Self {
        match value {
            molframe::surface::CurvatureQuality::Interior => Self::Interior,
            molframe::surface::CurvatureQuality::Boundary => Self::Boundary,
            molframe::surface::CurvatureQuality::Degenerate => Self::Degenerate,
        }
    }
}

impl From<molframe::surface::SurfaceCurvature> for PySurfaceCurvature {
    fn from(value: molframe::surface::SurfaceCurvature) -> Self {
        Self {
            mean: value.mean,
