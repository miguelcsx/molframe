...
#[derive(Clone, Debug)]
pub(crate) struct PyNcsSet(pub(crate) molframe::xtal::NcsSet);
...
impl PyStructure {
    fn symmetry_set(&self) -> Option<PySymmetrySet> {
        molframe::xtal::SymmetryExt::symmetry_set(self.structure())
            .cloned()
            .map(PySymmetrySet)
    }

    fn ncs_set(&self) -> Option<PyNcsSet> {
        molframe::xtal::NcsExt::ncs_set(self.structure())
            .cloned()
            .map(PyNcsSet)
    }
...
pub(crate) fn lower_ncs(py: Python<'_>, document: &PyCifDocument) -> PyResult<PyNcsSet> {
    ...
    py.detach(|| molframe::xtal::lower_ncs(&document.inner))
        .map(PyNcsSet)
...
impl From<molframe::xtal::NcsCode> for PyNcsCode {
    fn from(value: molframe::xtal::NcsCode) -> Self {
        match value {
            molframe::xtal::NcsCode::Given => Self::Given,
            molframe::xtal::NcsCode::Generate => Self::Generate,
        }
    }
}

impl From<molframe::xtal::NcsOperator> for PyNcsOperator {
    fn from(value: molframe::xtal::NcsOperator) -> Self {
        Self {
...
impl From<molframe::xtal::CrystalNeighbor> for PyCrystalNeighbor {
    fn from(value: molframe::xtal::CrystalNeighbor) -> Self {
        Self {
