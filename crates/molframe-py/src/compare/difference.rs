...
fn structure_difference_with_options(
    ...
    molframe::structure_difference(
        left.structure(),
        right.structure(),
        molframe::StructureDifferenceOptions {
...
impl From<molframe::StructureDifference> for PyStructureDifference {
    fn from(value: molframe::StructureDifference) -> Self {
        Self {
...
impl From<molframe::CountDifference> for PyCountDifference {
    fn from(value: molframe::CountDifference) -> Self {
        Self {
            left: value.left,
            right: value.right,
        }
...
impl From<molframe::MetadataDifference> for PyMetadataDifference {
    fn from(value: molframe::MetadataDifference) -> Self {
        Self {
...
fn text_change(
    value: Option<molframe::ValueDifference<Option<Box<str>>>>,
