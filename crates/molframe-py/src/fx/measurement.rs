...
pub(crate) struct PyMeasurementValue(pub(crate) molframe::fx::MeasurementValue);
...
impl PyMeasurementValue {
    ...
    fn scalar(value: f64) -> PyResult<Self> {
        ...
        Ok(Self(molframe::fx::MeasurementValue::Scalar(value)))
    }
    ...
    fn chirality(sign: i8) -> PyResult<Self> {
        ...
        Ok(Self(molframe::fx::MeasurementValue::Chirality(sign)))
    }

    #[staticmethod]
    fn count(value: usize) -> Self {
        Self(molframe::fx::MeasurementValue::Count(value))
    }

    #[getter]
    fn kind(&self) -> &'static str {
        match self.0 {
            molframe::fx::MeasurementValue::Scalar(_) => "scalar",
            molframe::fx::MeasurementValue::Chirality(_) => "chirality",
            molframe::fx::MeasurementValue::Count(_) => "count",
            _ => "unknown",
        }
    }
    ...
    fn scalar_value(&self) -> Option<f64> {
        match self.0 {
            molframe::fx::MeasurementValue::Scalar(value) => Some(value),
            _ => None,
        }
    }
    ...
    fn chirality_sign(&self) -> Option<i8> {
        match self.0 {
            molframe::fx::MeasurementValue::Chirality(value) => Some(value),
            _ => None,
        }
    }
    ...
    fn count_value(&self) -> Option<usize> {
        match self.0 {
            molframe::fx::MeasurementValue::Count(value) => Some(value),
            _ => None,
        }
    }
}
...
impl From<molframe::fx::IndeterminateReason> for PyIndeterminateReason {
    fn from(value: molframe::fx::IndeterminateReason) -> Self {
        match value {
            molframe::fx::IndeterminateReason::MissingCoordinate => Self::MissingCoordinate,
            molframe::fx::IndeterminateReason::DegenerateGeometry => Self::DegenerateGeometry,
        }
    }
}
...
impl From<molframe::fx::ConstraintMeasurement> for PyConstraintMeasurement {
    fn from(value: molframe::fx::ConstraintMeasurement) -> Self {
        Self {
...
#[derive(Clone, Debug)]
pub(crate) struct PyMeasurementSet(pub(crate) molframe::fx::MeasurementSet);
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct PyMeasurementOptions(pub(crate) molframe::fx::MeasurementOptions);
...
impl PyMeasurementOptions {
    ...
    fn new(maximum_alternatives: usize, plane_fit: Option<&PyEigenOptions>) -> PyResult<Self> {
        ...
        Ok(Self(molframe::fx::MeasurementOptions {
            maximum_alternatives,
            plane_fit: plane_fit.map_or_else(molframe::EigenOptions::standard, |value| value.inner),
        }))
    }
...
pub(crate) fn measure_constraints(
    ...
    py.detach(move || {
        molframe::fx::measure_constraints(&structure, &motif, &aligned, options)
