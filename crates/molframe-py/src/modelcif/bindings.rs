...
impl PyModelCategory {
    #[getter]
    fn name(&self) -> &str {
        self.inner().map_or("", molframe::ModelCategory::name)
    }
...
impl PyModelCategory {
    fn inner(&self) -> Option<&molframe::ModelCategory> {
...
metadata_projection!(PyModelDescription, "ModelDescription", molframe::ModelDescription<'_> {
    id: String,
    assembly_id: Option<String>,
    name: Option<String>,
    model_type: Option<String>,
});
metadata_projection!(PyTarget, "Target", molframe::Target<'_> {
    entity_id: String,
    data_id: Option<String>,
    origin: Option<String>,
});
metadata_projection!(PyTemplate, "Template", molframe::Template<'_> {
    id: String,
...
metadata_projection!(PyProtocolStep, "ProtocolStep", molframe::ProtocolStep<'_> {
    protocol_id: String,
    step_id: String,
    method_type: String,
    name: Option<String>,
...
pub(crate) struct PyModelCif {
    pub(crate) inner: Arc<molframe::ModelCif>,
}

impl PyModelCif {
    pub(crate) fn inner(&self) -> &molframe::ModelCif {
        &self.inner
    }
}
...
impl PyStructure {
    fn model_cif(&self) -> Option<PyModelCif> {
        self.structure()
            .extensions()
            .get_shared::<molframe::ModelCif>(molframe::MODEL_CIF_EXTENSION)
...
pub(crate) fn lower_model_cif(py: Python<'_>, document: &PyCifDocument) -> PyResult<PyModelCif> {
    ...
    let (model, findings) = py
        .detach(|| molframe::modelcif::lower(&document.inner))
...
impl PyQualityMetrics {
    fn from_model(model: Arc<molframe::ModelCif>) -> Self {
        Self { model }
    }
}

impl From<molframe::MetricDefinition<'_>> for PyMetricDefinition {
    fn from(value: molframe::MetricDefinition<'_>) -> Self {
        Self {
...
impl From<molframe::GlobalMetric<'_>> for PyGlobalMetric {
    fn from(value: molframe::GlobalMetric<'_>) -> Self {
        Self {
...
impl From<molframe::LocalMetric<'_>> for PyLocalMetric {
    fn from(value: molframe::LocalMetric<'_>) -> Self {
        Self {
            model_id: value.model_id.to_string(),
...
impl From<molframe::PairwiseMetric<'_>> for PyPairwiseMetric {
    fn from(value: molframe::PairwiseMetric<'_>) -> Self {
        Self {
            model_id: value.model_id.to_string(),
...
impl From<molframe::ModelDescription<'_>> for PyModelDescription {
    fn from(value: molframe::ModelDescription<'_>) -> Self {
        Self {
            id: value.id.to_string(),
...
impl From<molframe::Target<'_>> for PyTarget {
    fn from(value: molframe::Target<'_>) -> Self {
        Self {
...
impl From<molframe::Template<'_>> for PyTemplate {
    fn from(value: molframe::Template<'_>) -> Self {
        Self {
            id: value.id.to_string(),
...
impl From<molframe::ProtocolStep<'_>> for PyProtocolStep {
    fn from(value: molframe::ProtocolStep<'_>) -> Self {
        Self {
...
impl From<molframe::SoftwareGroup<'_>> for PySoftwareGroup {
    fn from(value: molframe::SoftwareGroup<'_>) -> Self {
        Self {
