...
policy_enum!("HydrogenPolicy", PyHydrogenPolicy, molframe::core::contract::HydrogenPolicy, {
    ExplicitOnly, IncludeInferred, Exclude
});
policy_enum!("EquivalencePolicy", PyEquivalencePolicy, molframe::core::contract::EquivalencePolicy, {
    None, Ccd, Explicit
});
policy_enum!("SymmetryPolicy", PySymmetryPolicy, molframe::core::contract::SymmetryPolicy, {
    None, Crystallographic, BiologicalAssembly
});
policy_enum!("Precision", PyPrecision, molframe::core::contract::Precision, { F32, F64 });
policy_enum!("PeriodicPolicy", PyPeriodicPolicy, molframe::core::contract::PeriodicPolicy, {
    None, Pbc, MinimumImage
});

impl From<molframe::core::contract::HydrogenPolicy> for PyHydrogenPolicy {
    fn from(value: molframe::core::contract::HydrogenPolicy) -> Self {
        match value {
            molframe::core::contract::HydrogenPolicy::IncludeInferred => Self::IncludeInferred,
            molframe::core::contract::HydrogenPolicy::Exclude => Self::Exclude,
            _ => Self::ExplicitOnly,
        }
    }
}

impl From<molframe::core::contract::EquivalencePolicy> for PyEquivalencePolicy {
    fn from(value: molframe::core::contract::EquivalencePolicy) -> Self {
        match value {
            molframe::core::contract::EquivalencePolicy::Explicit => Self::Explicit,
            _ => Self::Ccd,
        }
    }
}

impl From<molframe::core::contract::SymmetryPolicy> for PySymmetryPolicy {
    fn from(value: molframe::core::contract::SymmetryPolicy) -> Self {
        match value {
            molframe::core::contract::SymmetryPolicy::Crystallographic => Self::Crystallographic,
            molframe::core::contract::SymmetryPolicy::BiologicalAssembly => {
                Self::BiologicalAssembly
            }
            _ => Self::None,
        }
    }
...
impl From<molframe::core::contract::Precision> for PyPrecision {
    fn from(value: molframe::core::contract::Precision) -> Self {
        match value {
            molframe::core::contract::Precision::F32 => Self::F32,
            _ => Self::F64,
        }
    }
}

impl From<molframe::core::contract::PeriodicPolicy> for PyPeriodicPolicy {
    fn from(value: molframe::core::contract::PeriodicPolicy) -> Self {
        match value {
            molframe::core::contract::PeriodicPolicy::Pbc => Self::Pbc,
            molframe::core::contract::PeriodicPolicy::MinimumImage => Self::MinimumImage,
            _ => Self::None,
        }
    }
}

impl From<molframe::core::contract::AlignmentPolicy> for PyAlignmentPolicy {
    fn from(value: molframe::core::contract::AlignmentPolicy) -> Self {
        match value {
            molframe::core::contract::AlignmentPolicy::Explicit(selection) => {
                Self::Explicit(selection.into())
            }
            molframe::core::contract::AlignmentPolicy::Global => Self::Global(),
            molframe::core::contract::AlignmentPolicy::Local => Self::Local(),
            _ => Self::None(),
        }
    }
}

impl From<molframe::core::contract::ContactDefinition> for PyContactDefinition {
    fn from(value: molframe::core::contract::ContactDefinition) -> Self {
        match value {
...
impl From<PyAlignmentPolicy> for molframe::core::contract::AlignmentPolicy {
...
impl From<PyContactDefinition> for molframe::core::contract::ContactDefinition {
...
impl From<PyTolerance> for molframe::core::contract::Tolerance {
...
impl From<molframe::core::contract::Tolerance> for PyTolerance {
    fn from(value: molframe::core::contract::Tolerance) -> Self {
        Self {
            relative: value.relative,
            absolute: value.absolute,
        }
...
impl PyTolerance {
    ...
    #[staticmethod]
    fn standard() -> Self {
        <Self as From<molframe::core::contract::Tolerance>>::from(
            molframe::core::contract::Tolerance::default(),
        )
    }
}
...
impl From<PyPolicyField> for molframe::core::contract::PolicyField {
...
impl From<molframe::core::contract::PolicyField> for PyPolicyField {
    fn from(value: molframe::core::contract::PolicyField) -> Self {
        match value {
            molframe::core::contract::PolicyField::Assembly => Self::Assembly,
            molframe::core::contract::PolicyField::Model => Self::Model,
            molframe::core::contract::PolicyField::Altloc => Self::Altloc,
            molframe::core::contract::PolicyField::Identifiers => Self::Identifiers,
            molframe::core::contract::PolicyField::MissingAtoms => Self::MissingAtoms,
            molframe::core::contract::PolicyField::Hydrogens => Self::Hydrogens,
            molframe::core::contract::PolicyField::AtomEquivalence => Self::AtomEquivalence,
            molframe::core::contract::PolicyField::Symmetry => Self::Symmetry,
            molframe::core::contract::PolicyField::Alignment => Self::Alignment,
            molframe::core::contract::PolicyField::Precision => Self::Precision,
            molframe::core::contract::PolicyField::Periodic => Self::Periodic,
            molframe::core::contract::PolicyField::VdwRadii => Self::VdwRadii,
            molframe::core::contract::PolicyField::ContactDef => Self::ContactDef,
...
impl PyPolicyDimension {
    ...
    fn contact_def(values: Vec<PyContactDefinition>) -> Self {
        Self(molframe::PolicyDimension::contact_def(
            values.into_iter().map(Into::into),
        ))
    }
    #[staticmethod]
    fn float_tolerance(values: Vec<PyTolerance>) -> Self {
        Self(molframe::PolicyDimension::float_tolerance(
            values.into_iter().map(Into::into),
        ))
    }
    #[getter]
...
impl From<molframe::PlanError> for PyPlanError {
    fn from(value: molframe::PlanError) -> Self {
        let (field, cost, limit) = match value {
            molframe::PlanError::EmptyDimension(field)
            | molframe::PlanError::DuplicateDimension(field) => (Some(field.into()), None, None),
            molframe::PlanError::LimitExceeded { cost, limit } => (None, Some(cost), Some(limit)),
            _ => (None, None, None),
        };
        Self {
