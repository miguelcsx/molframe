...
impl From<molframe::traj::GamessRunType> for PyGamessRunType {
    fn from(value: molframe::traj::GamessRunType) -> Self {
        match value {
            molframe::traj::GamessRunType::Optimize => Self::Optimize,
            molframe::traj::GamessRunType::Surface => Self::Surface,
        }
    }
}

impl From<PyGamessRunType> for molframe::traj::GamessRunType {
...
impl From<molframe::traj::GamessAtom> for PyGamessAtom {
    fn from(value: molframe::traj::GamessAtom) -> Self {
        Self {
...
impl From<PyGamessAtom> for molframe::traj::GamessAtom {
...
impl From<molframe::traj::GamessFrame> for PyGamessFrame {
    fn from(value: molframe::traj::GamessFrame) -> Self {
        Self {
            step: value.step,
            energy: value.energy,
...
impl From<PyGamessFrame> for molframe::traj::GamessFrame {
...
impl From<molframe::traj::GamessTrajectory> for PyGamessTrajectory {
    fn from(value: molframe::traj::GamessTrajectory) -> Self {
        Self {
...
impl From<PyGamessTrajectory> for molframe::traj::GamessTrajectory {
...
pub(crate) fn parse_gamess_output(py: Python<'_>, text: &str) -> PyResult<PyGamessTrajectory> {
    py.detach(move || -> PyResult<PyGamessTrajectory> {
        molframe::traj::parse_gamess_output(text)
            .map(Into::into)
