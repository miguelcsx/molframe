...
impl PyImdLimits {
    ...
    fn new(max_atoms: Option<usize>) -> PyResult<Self> {
        let max_atoms = match max_atoms {
            Some(value) => value,
            None => {
                molframe::traj::ImdConnectionOptions::default()
                    .limits
                    .max_atoms
            }
        };
...
impl From<PyImdLimits> for molframe::traj::ImdLimits {
...
impl From<molframe::traj::ImdLimits> for PyImdLimits {
    fn from(value: molframe::traj::ImdLimits) -> Self {
        Self {
            max_atoms: value.max_atoms,
        }
    }
...
pub(crate) struct PyImdConnectionOptions {
    inner: molframe::traj::ImdConnectionOptions,
}
...
impl PyImdConnectionOptions {
    ...
    fn new(
        ...
        let defaults = molframe::traj::ImdConnectionOptions::default();
        Ok(Self {
            inner: molframe::traj::ImdConnectionOptions {
...
impl From<molframe::traj::ImdPeerEndian> for PyImdPeerEndian {
    fn from(value: molframe::traj::ImdPeerEndian) -> Self {
        match value {
            molframe::traj::ImdPeerEndian::Little => Self::Little,
            molframe::traj::ImdPeerEndian::Big => Self::Big,
        }
    }
}
...
impl From<molframe::traj::ImdEnergies> for PyImdEnergies {
    fn from(value: molframe::traj::ImdEnergies) -> Self {
        Self {
            step: value.step,
...
impl From<PyImdEnergies> for molframe::traj::ImdEnergies {
...
impl From<PyImdForce> for molframe::traj::ImdForce {
...
impl From<molframe::traj::ImdForce> for PyImdForce {
    fn from(value: molframe::traj::ImdForce) -> Self {
        Self {
            atom: value.atom,
            force: value.force,
        }
...
impl From<molframe::traj::ImdMessage> for PyImdMessage {
    fn from(value: molframe::traj::ImdMessage) -> Self {
        match value {
            molframe::traj::ImdMessage::Disconnect => Self::from_disconnect(),
            molframe::traj::ImdMessage::Energies(value) => Self::from_energies(value.into()),
            molframe::traj::ImdMessage::Coordinates(value) => Self::from_coordinates(value),
            molframe::traj::ImdMessage::Go => Self::from_go(),
            molframe::traj::ImdMessage::Kill => Self::from_kill(),
            molframe::traj::ImdMessage::Forces(value) => {
                Self::from_forces(value.into_iter().map(Into::into).collect())
            }
            molframe::traj::ImdMessage::Pause => Self::from_pause(),
            molframe::traj::ImdMessage::TransmissionRate(value) => {
...
pub(crate) struct PyImdClient {
    inner: molframe::traj::ImdClient<TcpStream>,
}
...
impl PyImdClient {
    ...
    fn connect(
        ...
        let options = options.map_or_else(molframe::traj::ImdConnectionOptions::default, |value| {
            value.inner
        });
        py.detach(move || molframe::traj::ImdClient::connect_with_options(address, options))
...
fn imd_error(error: molframe::traj::ImdError) -> PyErr {
