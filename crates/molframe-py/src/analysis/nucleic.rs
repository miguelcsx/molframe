...
impl PyStructure {
    fn nucleic_torsions(&self, py: Python<'_>) -> PyResult<Vec<PyNucleicTorsions>> {
        ...
        py.detach(move || molframe::analysis::nucleic_torsions(&structure))
...
pub(crate) fn sugar_pucker(py: Python<'_>, torsions: [f64; 5]) -> PyPucker {
    py.detach(move || molframe::analysis::sugar_pucker(torsions))
        .into()
}

impl From<molframe::analysis::NucleicTorsions> for PyNucleicTorsions {
    fn from(value: molframe::analysis::NucleicTorsions) -> Self {
        Self {
...
impl From<molframe::analysis::Pucker> for PyPucker {
    fn from(value: molframe::analysis::Pucker) -> Self {
        Self {
