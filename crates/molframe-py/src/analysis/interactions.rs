...
#[derive(Clone, Debug)]
pub(crate) struct PyDsspOptions(molframe::analysis::DsspOptions);
...
impl PyDsspOptions {
    ...
    fn new(
        ...
        Self(molframe::analysis::DsspOptions {
...
impl PyDsspOptions {
    pub(crate) fn native(&self) -> molframe::analysis::DsspOptions {
        self.0.clone()
    }

    pub(crate) fn from_native_parts(value: molframe::analysis::DsspOptions) -> Self {
        Self(value)
    }
}
...
impl PyStructure {
    ...
    fn secondary_structure(
        ...
        py.detach(move || molframe::analysis::secondary_structure(&structure, &options))
            .map(|values| {
                values
                    .into_iter()
...
impl From<molframe::analysis::Contact> for PyContact {
    fn from(value: molframe::analysis::Contact) -> Self {
        Self {
...
impl From<Vec<molframe::analysis::Contact>> for PyContactTable {
    fn from(contacts: Vec<molframe::analysis::Contact>) -> Self {
...
impl From<molframe::analysis::SseKind> for PySseKind {
    fn from(value: molframe::analysis::SseKind) -> Self {
        match value {
            molframe::analysis::SseKind::AlphaHelix => Self::AlphaHelix,
            molframe::analysis::SseKind::Strand => Self::Strand,
            molframe::analysis::SseKind::Turn => Self::Turn,
            molframe::analysis::SseKind::Coil => Self::Coil,
        }
    }
}

impl From<molframe::analysis::SseRecord> for PySseRecord {
    fn from(value: molframe::analysis::SseRecord) -> Self {
        Self {
            residue: value.residue.get(),
            kind: value.kind.into(),
        }
...
pub(crate) fn contact_analysis_to_py(
    py: Python<'_>,
    analysis: molframe::Analysis<Vec<molframe::analysis::Contact>>,
) -> PyResult<PyAnalysis> {
