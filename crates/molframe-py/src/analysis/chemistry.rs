...
pub(crate) struct PyHydrogenBondOptions(molframe::analysis::HydrogenBondOptions);
...
impl PyHydrogenBondOptions {
    ...
    fn new(
        ...
        Self(molframe::analysis::HydrogenBondOptions {
...
impl PyHydrogenBondOptions {
    pub(crate) const fn native(&self) -> molframe::analysis::HydrogenBondOptions {
        self.0
    }
}
...
#[derive(Clone, Debug)]
pub(crate) struct PyPiStackingOptions(molframe::analysis::PiStackingOptions);
...
impl PyPiStackingOptions {
    ...
    fn new(
        ...
        Self(molframe::analysis::PiStackingOptions {
...
impl PyPiStackingOptions {
    pub(crate) const fn native(&self) -> molframe::analysis::PiStackingOptions {
        self.0
    }

    pub(crate) const fn from_native_parts(value: molframe::analysis::PiStackingOptions) -> Self {
        Self(value)
    }
}
...
#[derive(Clone, Debug)]
pub(crate) struct PyCationPiOptions(molframe::analysis::CationPiOptions);

#[pymethods]
impl PyCationPiOptions {
    #[new]
    fn new(maximum_distance: f32, maximum_face_angle: f64, plane_fit: &PyEigenOptions) -> Self {
        Self(molframe::analysis::CationPiOptions {
            maximum_distance,
            maximum_face_angle,
            plane_fit: plane_fit.inner,
        })
...
impl PyCationPiOptions {
    pub(crate) const fn native(&self) -> molframe::analysis::CationPiOptions {
        self.0
    }

    pub(crate) const fn from_native_parts(value: molframe::analysis::CationPiOptions) -> Self {
        Self(value)
    }
}
...
impl PyWaterBridgeOptions {
    pub(crate) const fn native(&self) -> molframe::analysis::WaterBridgeOptions {
        molframe::analysis::WaterBridgeOptions {
            hydrogen_bonds: self.0.native(),
        }
    }

    pub(crate) const fn from_native_parts(value: molframe::analysis::WaterBridgeOptions) -> Self {
...
impl PyStructure {
    ...
    fn hydrogen_bonds(
        ...
        py.detach(move || molframe::analysis::hydrogen_bonds(&structure, options, &context))
    ...
    fn salt_bridges(
        ...
        let context = context.map_or_else(default_context, PyExecutionContext::native);
        py.detach(move || {
            molframe::analysis::salt_bridges(&structure, maximum_distance, backend.into(), &context)
        })
    ...
    fn pi_stacking(
        ...
        let structure = self.structure().clone();
        let options = options.0;
        py.detach(move || molframe::analysis::pi_stacking(&structure, options))
    ...
    fn cation_pi(&self, py: Python<'_>, options: &PyCationPiOptions) -> PyResult<Vec<PyCationPi>> {
        let structure = self.structure().clone();
        let options = options.0;
        py.detach(move || molframe::analysis::cation_pi(&structure, options))
    ...
    fn water_bridges(
        ...
        let context = context.map_or_else(default_context, PyExecutionContext::native);
        py.detach(move || {
            molframe::analysis::water_bridges(
                &structure,
                molframe::analysis::WaterBridgeOptions {
...
impl From<molframe::analysis::HydrogenBond> for PyHydrogenBond {
    fn from(value: molframe::analysis::HydrogenBond) -> Self {
        Self {
...
impl From<molframe::analysis::SaltBridge> for PySaltBridge {
    fn from(value: molframe::analysis::SaltBridge) -> Self {
        Self {
...
impl From<molframe::analysis::PiStacking> for PyPiStacking {
    fn from(value: molframe::analysis::PiStacking) -> Self {
        Self {
...
impl From<molframe::analysis::StackingKind> for PyStackingKind {
    fn from(value: molframe::analysis::StackingKind) -> Self {
        match value {
            molframe::analysis::StackingKind::Parallel => Self::Parallel,
            molframe::analysis::StackingKind::TShaped => Self::TShaped,
        }
    }
}

impl From<molframe::analysis::CationPi> for PyCationPi {
    fn from(value: molframe::analysis::CationPi) -> Self {
        Self {
...
impl From<molframe::analysis::WaterBridge> for PyWaterBridge {
    fn from(value: molframe::analysis::WaterBridge) -> Self {
        Self {
