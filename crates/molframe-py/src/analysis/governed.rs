...
class_list!(contact_list, molframe::analysis::Contact, PyContact);
class_list!(
    hse_list,
...
class_list!(clash_list, molframe::validate::Clash, PyClash);
class_list!(
    bond_list,
    molframe::validate::BondDeviation,
    PyBondDeviation
);
class_list!(cis_list, molframe::validate::CisPeptide, PyCisPeptide);
class_list!(
    planarity_list,
    molframe::validate::PlanarityFlag,
    PyPlanarityFlag
);
class_list!(quality_list, molframe::validate::QualityFlag, PyQualityFlag);
class_list!(
    valence_list,
...
fn index_list(py: Python<'_>, values: Vec<molframe::ResidueIndex>) -> PyResult<Py<PyAny>> {
    Ok(
...
pub(crate) fn analyse_contacts(
    ...
    let analysis = py
        .detach(|| {
            let kernel = molframe::analysis::contacts_kernel(cutoff, backend.into());
            molframe::analysis::analyse_structure(
                &structure,
                &policy,
                &kernel,
...
pub(crate) fn analyse_half_sphere_exposure(
    ...
    let analysis = py
        .detach(|| {
            let kernel = molframe::analysis::half_sphere_exposure_kernel(radius, backend.into());
            molframe::analysis::analyse_structure(
                &structure,
                &policy,
                &kernel,
...
governed_list!(
    ...
    torsion_list,
    molframe::analysis::nucleic_torsions_kernel()
);
...
pub(crate) fn validate_clashes(
    ...
    let analysis = py
        .detach(|| {
            let kernel =
                molframe::validate::clashes_kernel(tolerance, radii.into(), backend.into());
            molframe::analysis::analyse_structure(
                &structure,
                &policy,
                &kernel,
...
pub(crate) fn validate_bond_lengths(
    ...
    let analysis = py
        .detach(|| {
            let kernel = molframe::validate::bond_length_deviations_kernel(tolerance);
            molframe::analysis::analyse_structure(
                &structure,
                &policy,
                &kernel,
...
pub(crate) fn validate_cis_peptides(
    ...
    let analysis = py
        .detach(|| {
            let kernel = molframe::validate::cis_peptides_kernel(threshold_degrees);
            molframe::analysis::analyse_structure(
                &structure,
                &policy,
                &kernel,
...
pub(crate) fn validate_planarity(
    ...
    let analysis = py
        .detach(|| {
            let kernel = molframe::validate::planarity_kernel(options.0);
            molframe::analysis::analyse_structure(
                &structure,
                &policy,
                &kernel,
...
governed_list!(
    validate_quality,
    quality_list,
    molframe::validate::quality_flags_kernel()
);
governed_list!(
    validate_valence,
    valence_list,
    molframe::validate::valence_kernel()
);
...
pub(crate) fn validate_completeness(
    ...
    let analysis = py
        .detach(|| {
            let kernel = molframe::validate::completeness_kernel();
            molframe::analysis::analyse_structure(
                &structure,
                &policy,
                &kernel,
