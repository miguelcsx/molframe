...
pub(crate) enum PyPhysicalOperation {
    RadialDistribution {
        left: molframe::AtomSelection,
        right: molframe::AtomSelection,
        options: molframe::analysis::RadialDistributionOptions,
        periodic: bool,
    ...
    CoordinationNumbers {
        ...
        backend: molframe::SpatialBackend,
        periodic: bool,
        policy: molframe::AnalysisPolicy,
    },
    Leaflets {
        sites: molframe::AtomSelection,
        options: molframe::analysis::LeafletOptions,
        periodic: bool,
        policy: molframe::AnalysisPolicy,
    },
    LinearDensity {
        weights: Py<PyAny>,
        options: molframe::analysis::LinearDensityOptions,
        policy: molframe::AnalysisPolicy,
    },
    DensityMap {
        weights: Py<PyAny>,
    ...
    PoreProfile {
        radii: Py<PyAny>,
        options: molframe::analysis::PoreProfileOptions,
        policy: molframe::AnalysisPolicy,
    },
    SurfaceContacts {
        radii: Py<PyAny>,
...
pub(super) fn execute_operation(
    ...
    match entry.value {
        molframe::PlanValue::Physical(value) => value_to_python(py, *value),
...
fn value_to_python(
    py: Python<'_>,
    value: molframe::PhysicalValue,
) -> PyResult<crate::contract::PyAnalysis> {
    match value {
        molframe::PhysicalValue::RadialDistribution(value) => radial_analysis(py, value),
        molframe::PhysicalValue::CoordinationNumbers(value) => coordination_analysis(py, value),
        molframe::PhysicalValue::Leaflets(value) => leaflets_analysis(py, value),
        molframe::PhysicalValue::LinearDensity(value) => linear_density_analysis(py, value),
        molframe::PhysicalValue::DensityMap(value) => density_map_analysis(py, value),
        molframe::PhysicalValue::PoreProfile(value) => pore_analysis(py, value),
        molframe::PhysicalValue::SurfaceContacts(value) => surface_contacts_analysis(py, value),
    }
}
