...
fn lower_contacts(
    ...
    let request = molframe::ContactsRequest::new(
...
fn lower_structure(
    ...
    native
        .add(
            name.to_owned(),
            molframe::PlanOperation::Structure(Box::new(request.clone())),
        )
        .map_err(plan_error)
}
...
fn lower_physical<'py>(
    ...
    native
        .add(
            name.to_owned(),
            molframe::PlanOperation::Physical(Box::new(request)),
        )
        .map_err(plan_error)
}
...
fn lower_surface<'py>(
    ...
    native
        .add(
            name.to_owned(),
            molframe::PlanOperation::Surface(Box::new(request)),
        )
        .map_err(plan_error)
}
...
fn lower_geometry<'py>(
    ...
    native
        .add(
            name.to_owned(),
            molframe::PlanOperation::Geometry(Box::new(request)),
        )
        .map_err(plan_error)
}
...
fn lower_spatial<'py>(
    ...
    native
        .add(
            name.to_owned(),
            molframe::PlanOperation::Spatial(Box::new(request)),
        )
        .map_err(plan_error)
}
...
pub(super) fn plan_error(error: molframe::ExecutionPlanError) -> PyErr {
